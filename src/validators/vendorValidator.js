...
const validateCreateVendor = ValidationHelper.validate(vendorCreateSchema);
const validateUpdateVendor = ValidationHelper.validate(vendorUpdateSchema);
const validateVendorQuery = ValidationHelper.validateQuery(vendorQuerySchema);
